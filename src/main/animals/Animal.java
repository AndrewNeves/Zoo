...
/**
 * This is the abstract animal base class from which all other animals are
 * derived.
 */
public abstract class Animal {
     ...
     * 
     * @param isThirsty      Sets whether or not animal is thirsty. This field must
     *                       be set to false for {@link main.animals.IWaterAnimal
     *                       IWaterAnimals}.
     * @param isHungry       Sets whether or not animal is hungry.
     * @param sleepWakeState Sets whether animal is awake or asleep.
     * @throws UnsupportedOperationException If attempting to initialize
     *                                       {@link main.animals.IWaterAnimal
     *                                       IWaterAnimal} as thirsty.
     */
    public Animal(boolean isThirsty, boolean isHungry, SleepWakeState sleepWakeState)
            throws UnsupportedOperationException {
        if (this instanceof IWaterAnimal && isThirsty) {
            throw new UnsupportedOperationException(
                    "Attempted to initialize IWaterAnimal as thirsty. " + "IWaterAnimals cannot be thirsty.");
        } else {
    ...
    /**
     * Animal constructor that initializes the animal's fields based on the output
     * from a random number generator. {@link main.animals.IWaterAnimal
     * IWaterAnimals} are always initialized with isThirsty=false.
     * 
    ...
    /**
     * Animal constructor accepting only isHungry and sleepWakeState for
     * initialization. isThirsty is Automatically initialized to false. This
     * constructor is meant to be called by {@link main.animals.IWaterAnimal
     * IWaterAnimals} which cannot be thirsty.
     * 
     * @param isHungry       Sets whether or not animal is hungry.
     * @param sleepWakeState Sets whether animal is awake or asleep.
     */
    ...
    public SleepWakeState sleepWakeState() {
        return sleepWakeState;
    }

    /**
     * Feeding a hungry animal will make them not hungry. Feeding an animal that is
     * not hungry will have no effect.
     * 
    ...
    /**
     * Giving water to a thirsty animal will make them not thirsty. Giving water to
     * an animal that is not thirsty will have no effect.
     * 
    ...
    /**
     * Putting an awake animal to sleep will change their sleepWakeState to
     * Sleeping. Putting a sleeping animal to sleep will have no effect.
     * 
     * @return Status indicating if sleepWakeState has been updated.
     * @throws UnsupportedOperationException If attempting to put a
     *                                       non-{@link main.animals.IAirBreather
     *                                       IAirBreather} to sleep.
     */
    ...
    /**
     * Waking up a sleeping animal will change their sleepWakeState to Awake. Waking
     * up an animal that is already awake will have no effect.
     * 
     * @return Status indicating if sleepWakeState has been updated.
     * @throws UnsupportedOperationException If attempting to wake up a
     *                                       non-{@link main.animals.IAirBreather
     *                                       IAirBreather}.
     */
    ...
    /**
     * Updates the animal's fields based on the output from a random number
     * generator. {@link main.animals.IWaterAnimal IWaterAnimals} isThirsty always
     * set to false.
     * 
     * @param rand A random number generator
     * @throws IllegalArgumentException If rand is null.
