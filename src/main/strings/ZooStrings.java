...
/**
 * This class contains command line interface string constants and
 * {@link main.Zoo Zoo} related string array parsing methods.
 */
public final class ZooStrings {

    /**
     * Command line interface command for feeding hungry, awake
     * {@link main.animals.Animal Animals}.
     */
    public static final String FEED_CMD = "feed";
    /**
     * Command line interface command for giving water to thirsty
     * {@link main.animals.Animal Animals}.
     */
    public static final String GIVE_WATER_CMD = "water";
    /**
     * Command line interface command for putting awake
     * {@link main.animals.IAirBreather IAirBreathers} to sleep at night.
     */
    public static final String PUT_TO_SLEEP_CMD = "sleep";
    /**
     * Command line interface command for waking up sleeping
     * {@link main.animals.IAirBreather IAirBreathers} during the day.
     */
    ...
    /**
     * Command line interface command for generating new {@link main.animals.Animal
     * Animal} and {@link main.Zoo Zoo} conditions.
     */
    ...
    /**
     * Checks a command line arguments array to see if all included arguments are
     * valid.
     * 
    ...
    public static boolean areArgumentsValid(String[] args) {
        ...
        for (String arg : args) {
            if (arg.equals(TIGER_ARG) || arg.equals(WHALE_ARG) || arg.equals(GOLDFISH_ARG)) {
                continue;
            } else {
                allArgsValid = false;
                break;
