...
public class Main {
    ...
    /**
     * Main application entry method. Creates the {@link main.Zoo Zoo} and
     * {@link main.Zookeeper Zookeeper}. Gets input from the command line and passes
     * it to the zookeeper from processing. Exits when the input is
     * {@value main.strings.ZooStrings#EXIT_CMD} or
     * {@value main.strings.ZooStrings#QUIT_CMD}.
     * 
     * @param args Not used
     */
